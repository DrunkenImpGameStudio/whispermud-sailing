...
module.exports = {
	listeners: {
		ready: state => function (config) {
			/* On room#ready, spawn a port sign, then change its description to match the list of destinations listed in config, giving each one a numeric index that is used by the travel command
